...
private  let account = Bundle.main.bundleIdentifier!

func KMSave(value: String, forKey key: String) -> OSStatus {
...
func KMUpdate(value: String, forKey key: String) -> OSStatus {
...
func KMSaveOrUpdate(value: String, forKey key: String) -> OSStatus {
...
func KMRemoveValue(forKey key: String) throws -> OSStatus {
    // Instantiate a new default keychain query
    let keychainQuery: NSMutableDictionary = NSMutableDictionary(
...
func KMGetValue(forKey key: String) -> String? {
    // Instantiate a new default keychain query
